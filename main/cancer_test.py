...
def measure_data(url, classColumn, noID, samplingType, normalizeType, selectBest, kBest=10):
    ...
    dt_label_prediction, dt_proba = getPredictionData("decisionTree", x_train, x_test, y_train, y_test)
    ...
    nb_label_prediction, nb_proba = getPredictionData("NaiveBayes", x_train, x_test, y_train, y_test)
    ...
    kn_label_prediction, kn_proba = getPredictionData("kNeighbours", x_train, x_test, y_train, y_test, 5)
